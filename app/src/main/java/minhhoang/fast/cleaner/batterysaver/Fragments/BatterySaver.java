...
import minhhoang.fast.cleaner.batterysaver.Noraml_Mode;
import minhhoang.fast.cleaner.batterysaver.PowerSaving_popup;
import com.minhhoang.fast.cleaner.batterysaver.R;
import minhhoang.fast.cleaner.batterysaver.Ultra_PopUp;
...
//            mWaveLoadingView.setBottomTitle(level+"%");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            mWaveLoadingView.setWaveColor(Color.parseColor("#103280"));
            mWaveLoadingView.setBorderColor(Color.parseColor("#103280"));
