...
import minhhoang.fast.cleaner.batterysaver.Classes.Apps;
import minhhoang.fast.cleaner.batterysaver.Cpu_Scanner;
import minhhoang.fast.cleaner.batterysaver.MainActivity;
import com.minhhoang.fast.cleaner.batterysaver.R;
import minhhoang.fast.cleaner.batterysaver.RecyclerAdapter;
...
//                        getActivity().unregisterReceiver(batteryReceiver);
                                    ...
                                    coolbutton.setImageResource(R.drawable.cooled2);
...
//                recyclerView.getItemAnimator().setChangeDuration(1000);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            tempimg.setImageResource(R.drawable.blue_cooler1);
